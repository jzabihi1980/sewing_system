...
@if(Session::has('message-success') == 'true')
    <div class="alert alert-success">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            <strong>Title!</strong>{{Session::get('message-success')}}
    </div>
@endif
</div>
    ...
    <div class="page-heading">
        <h3>
            Страница предметов интерьера авто
        </h3>
        <ul class="breadcrumb">
            <li>
                <a href="{{url('/')}}">Главная</a>
            </li>
            <li class="active"> Интерьера авто </li>
        </ul>
    </div>
@stop
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                        <button id="add-auto" class="btn btn-primary">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                                    <input type="text" class="form-control" id="inputNameFolderAuto" placeholder="Названия категории">
                                </div>
                                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                    <button id="edit-folder-auto" class="btn btn-primary">
                                            Изменить
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                    <button id="add-folder-auto" class="btn btn-primary">
                                            Добавить
                                    </button>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    var defaultData = <?php echo(string)($interiorAutoFolder);?>;
...
$('#add-auto').on('click', function(e){
    ...
    app.ajaxPost('auto/add-auto', formData, function(data){
            $('.table-striped').find('tbody').html('');
            recDataRows([data]);
    });
});
$('#add-folder-auto').on('click', function(e){
    var inputFolderWork = $('#inputFolderWork').val();
    var formData = new FormData();
    formData.append('name', inputFolderWork);
    formData.append('sid', application.id);
    app.ajaxPost('auto/add-folder-auto', formData, function(data){
        location.reload();
    });
});
...
$('#edit-folder-auto').on('click', function(e) {
    var formData = new FormData();
    formData.append('id', application.id);
    formData.append('name', $('#inputNameFolderAuto').val());
    app.ajaxPost('auto/edit-folder-auto', formData, function(data){
       location.reload(); 
    });
})
var initSelectableTree = function() {
    return $('#treeview-selectable').treeview({
        ...
        onNodeSelected: function(event, node) {
            ...
            $('#inputNameFolderAuto').val(node.text);
